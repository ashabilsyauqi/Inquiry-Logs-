...
REPLACE INTO `brand_supervisors` (`id`, `user_id`, `wa_account_id`, `created_at`, `updated_at`) VALUES
...
-- Table: leads
REPLACE INTO `leads` (`id`, `wa_account_id`, `name`, `phone`, `stage`, `ai_suggested_stage`, `ai_concluded_stage`, `ai_suggested_keyword`, `ai_suggestion_reason`, `ai_suggested_at`, `created_at`, `updated_at`, `notes`, `priority`, `assigned_user_id`) VALUES
...
-- Table: lead_messages
REPLACE INTO `lead_messages` (`id`, `lead_id`, `sender`, `message`, `is_from_me`, `created_at`, `updated_at`) VALUES
...
REPLACE INTO `pipeline_stages` (`id`, `wa_account_id`, `name`, `order`, `is_default`, `color`, `created_at`, `updated_at`) VALUES
...
REPLACE INTO `stage_triggers` (`id`, `wa_account_id`, `pipeline_stage_id`, `keyword`, `created_at`, `updated_at`) VALUES
...
-- Table: users
REPLACE INTO `users` (`id`, `name`, `email`, `phone`, `role`, `status`, `wa_account_id`, `session_id`, `wa_status`, `wa_phone`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
...
-- Table: wa_accounts
REPLACE INTO `wa_accounts` (`id`, `name`, `category`, `phone`, `session_id`, `status`, `approval_status`, `supervisor_id`, `disconnect_email_enabled`, `disconnect_email_interval`, `disconnect_alert_emails`, `last_disconnect_email_sent_at`, `created_at`, `updated_at`) VALUES
